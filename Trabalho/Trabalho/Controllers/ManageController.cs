...
#region Auxiliadores
        ...
        public async Task<ActionResult> Admin(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Sua senha foi alterada."
                : message == ManageMessageId.SetPasswordSuccess ? "Sua senha foi definida."
            ...
            //ApplicationUser user = await UserManager.FindAsync(model.Email, model.Password);
            // Redirect to User landing page on SignIn, according to Role
            return View("Administrador/Index", model);
        }

        //
        // GET: /Manage/Pais
        [Authorize(Roles = "Pais")]
        public async Task<ActionResult> Pais(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Sua senha foi alterada."
                : message == ManageMessageId.SetPasswordSuccess ? "Sua senha foi definida."
        ...
        public async Task<ActionResult> Instituições(ManageMessageId? message)
        {
            ...
            //ApplicationUser user = await UserManager.FindAsync(model.Email, model.Password);
            // Redirect to User landing page on SignIn, according to Role
            return View("Instituições/Index", model);
        }

        //
        // GET: /Manage/Geral
        [Authorize(Roles = "Geral")]
        public async Task<ActionResult> Geral(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Sua senha foi alterada."
                : message == ManageMessageId.SetPasswordSuccess ? "Sua senha foi definida."
